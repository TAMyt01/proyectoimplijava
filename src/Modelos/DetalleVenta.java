...
public class DetalleVenta {
    ...
    public DetalleVenta(int idDetalleVenta, int idCabeceraVenta, String idProducto, String nombre, int cantidad, double precioUnitario,double totalPagar, int estado) {
