...
public class frm_AgregarCategoria extends javax.swing.JDialog {
    ...
    public static void setPanelCategoria(jpanelCategoria panel) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtDesc, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtNombre.getText().isEmpty() ) {
            ...
            if (!ccontrolCategoria.existeCategoria(txtNombre.getText())) {
                ...
                if (ccontrolCategoria.guardar()) {
                    JOptionPane.showMessageDialog(null, "Registro guardado");
                    panelcategoria.cargaTablaCategoria();//Actualizamos tabla del panel principal de la categoria
                } else {
    ...
    private void txtNombreKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNombreKeyTyped
        // TODO add your handling code here:
        if (txtNombre.getText().length() >= 130) {
            evt.consume();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_AgregarCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
